...
@DoNotDiscover
class FilmCodeGenerationFromURLDataTest extends AnyFunSuite with BeforeAndAfter with ClassGenerator {
  ...
  before {
    generateClasses(pathToData = Option("https://raw.githubusercontent.com/herminiogg/dmaog/main/src/test/resources/data.ttl"))
  }
